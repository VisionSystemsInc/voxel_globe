...
def ingest_data(self, uploadSession_id, imageDir):
  ...
  for d in glob(os.path.join(imageDir, '*\\')):
    ...
    for f in files:
      ...
      image_info = {}
      if magic == '49492A00'.decode('hex') or magic == '4D4D002A'.decode('hex'):
      ...
      saveKrt(self.request.id, img, k, r, t, origin);
