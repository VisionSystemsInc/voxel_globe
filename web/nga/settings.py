...
GEOS_LIBRARY_PATH=env['NPR_DJANGO_GEOS_LIBRARY_PATH'];
GDAL_LIBRARY_PATH=env['NPR_DJANGO_GDAL_LIBRARY_PATH'];
...
DEBUG = env['NPR_DJANGO_DEBUG']

TEMPLATE_DEBUG = env['NPR_DJANGO_TEMPLATE_DEBUG']
