...
if "%1"=="start_httpd" (
  ...
  ipython notebook --notebook-dir=%VIP_NOTEBOOK_RUN_DIR% --no-browser --port=%VIP_NOTEBOOK_PORT% --ip=%VIP_NOTEBOOK_IP% --matplotlib=inline > %VIP_LOG_DIR%/notebook_out.log 2> %VIP_LOG_DIR%/notebook_err.log
